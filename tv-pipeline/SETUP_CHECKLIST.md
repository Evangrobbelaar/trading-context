...
5. Notifications tab -> tick Webhook URL -> paste: http://2.24.130.64/tv-signal?key=YOUR_REAL_KEY (Claude Code gives you this). Message box: leave as-is — the script supplies the JSON.
